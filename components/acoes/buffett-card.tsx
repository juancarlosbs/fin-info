  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        {result.isValid && result.safetyPrice !== null ? (
          <>
            ...
            <div className="grid grid-cols-2 gap-3 text-sm border-t pt-4">
              <div>
                ...
                <p className="font-medium">{result.price !== null ? formatBRL(result.price) : "—"}</p>
              </div>
              <div>
                <p className="text-muted-foreground text-xs">OE/ação</p>
                <p className="font-medium">{result.oePerShare !== null ? formatBRL(result.oePerShare) : "—"}</p>
              </div>
              <div>
